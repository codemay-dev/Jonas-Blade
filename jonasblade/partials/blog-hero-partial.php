...
<div id="hero" class="col-12 p-0 panelWrap inner" style="background-image: url('https://jonasblade.com/wp-content/uploads/2019/01/Jonas-Jan2017-030-2.jpg')">
  ...
  <div class="heroContent row align-items-center justify-content-center <?php if( get_field('overlay_type') == 'light' ) { ?>light<?php } elseif( get_field('overlay_type') == 'dark' ) { ?>dark<?php } ?>">
    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
      ...
      <?php } else { ?>
        <div class="heroText text-center"><h1><?php wp_title(); ?></h1></div>
      <?php }
